...
const mysql_controller = require('../controllers/mysql_controller.js');
...
Bucket.create = async(bucketToCreate, result) => {
    try {
        ...
        db_controller.getConnection(function(err, connection) {
            ...
            connection.query(CREATE_BUCKET_STATEMENT, [bucketToCreate.bucket, bucketToCreate.username], function(err, res) {
                //Error from DB     
                if (err) {
